/*
* Documentation:
* I changed this file by adding a Setter and a Getter. The purpose of these was so that
* I could add a resizing feature to the program. By clicking the + button, the size of
* the form increases, and by clicking the - button, the size of the form decreases.
*/
...
public:
   ...
   //-----------------------------------------------------------------
   // Allows the user to resize the size of the boxes
   //-----------------------------------------------------------------
   void setCellSize(int in) { CELLSIZE = in; }

   //-----------------------------------------------------------------
   // Allows the user to view the size of the boxes
   //-----------------------------------------------------------------
...
private:
   ...
   // changed the CellSize to be modifiable
   int CELLSIZE = 16;
